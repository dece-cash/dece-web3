 ...
 */
SolidityCoder.prototype.encodeParam = function (type, param,rand,dece) {
...
SolidityCoder.prototype.opParams = function (types, params,rand,dece,dy,callback) {
    var solidityTypes = this.getSolidityTypes(types);
    ...
    if (callback){
        ...
        dece.convertAddressParams(rand,addressParams,dy,cb);
    }else{
        var convertResult =  dece.convertAddressParams(rand,addressParams,dy);
