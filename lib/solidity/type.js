...
SolidityType.prototype.encode = function (value, name,shortAddrMap) {
    ...
    if (this._inputDeceShortAddrFormatter && shortAddrMap) {
        return this._inputDeceShortAddrFormatter(shortAddrMap[value], name).encode();
    }else {
...
/**
 * Should be used to encode the value,used by dece
 *
 * @method encode
 * @param {Object} value
 * @param {String} name
 * @return {String} encoded value
 */
SolidityType.prototype.encodeDece = function (value, name) {
    var self = this;
    if (this.isDynamicArray(name) || this.isStaticArray(name)) {
        ...
        return (function () {
            ...
            var result = [];
            value.forEach(function (v) {
                result.push(self.encodeDece(v, nestedName));
            });
    ...
    if (self._deceInputFormatter) {
        return self._deceInputFormatter(value);
    }
...
SolidityType.prototype.address = function (value, name,isHex) {
    ...
    if (isHex) {
        return self._inputDeceAddressFormatter(value);
    }else{
        return value;
    }
...
SolidityType.prototype.convertAddress = function (value, name,addrMap) {
    ...
    if ( self._inputDeceAddressFormatter){
...
SolidityType.prototype.decode = function (bytes, offset, name,mapaddr) {
    ...
    if (this._outDeceAddressFormatter) {
        if (mapaddr){
...
SolidityType.prototype.decodeAddress = function (bytes, offset, name) {
    var self = this;
    if (self._outDeceAddressFormatter){
        if (this.isDynamicArray(name)) {
